...
class Ui_SystemValuesWidget(object):
    def setupUi(self, SystemValuesWidget):
        ...
        SystemValuesWidget.resize(296, 170)
        ...
        self.gridLayout_2.addWidget(self.power_name_label, 4, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.power_left_value_label, 4, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.power_right_value_label, 4, 2, 1, 1)
