...
class Ui_ControllerParametersWidget(object):
    def setupUi(self, ControllerParametersWidget):
        ...
        ControllerParametersWidget.resize(344, 247)
        ...
        self.gridLayout.addWidget(self.enable_disable_pushbutton, 5, 2, 1, 1)
        ...
        self.igain_left_dblspinbox.setMaximum(1000.000000000000000)
        ...
        sizePolicy1.setHeightForWidth(self.controller_parameters_left_label.sizePolicy().hasHeightForWidth())
        self.controller_parameters_left_label.setSizePolicy(sizePolicy1)
        ...
        self.igain_right_dblspinbox.setMaximum(1000.000000000000000)
        ...
        sizePolicy3.setHeightForWidth(self.pgain_right_dblspinbox.sizePolicy().hasHeightForWidth())
        self.pgain_right_dblspinbox.setSizePolicy(sizePolicy3)
        ...
        self.gridLayout.addWidget(self.setpoint_units_label, 4, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.setpoint_left_dblspinbox, 4, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.setpoint_right_dblspinbox, 4, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.controller_name_label, 5, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.offset_right_dblspinbox, 3, 2, 1, 1)
        ...
        sizePolicy3.setHeightForWidth(self.pgain_left_dblspinbox.sizePolicy().hasHeightForWidth())
        self.pgain_left_dblspinbox.setSizePolicy(sizePolicy3)
        ...
        self.gridLayout.addWidget(self.offset_name_label, 3, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.offset_left_dblspinbox, 3, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.setpoint_name_label, 4, 0, 1, 1)
